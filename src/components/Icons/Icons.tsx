...
export function Speakerphone(props: any) {
  return (
...
export function HashtagWithSpeechBubble(props: any) {
  return (
...
export function QuestionCircle(props: any) {
  return (
    <svg viewBox='0 0 24 24' {...props}>
      <path
        fill='currentColor'
...
export function Hourglass(props: any) {
  return (
    <svg viewBox='0 0 24 24' {...props}>
      <path
        fill='currentColor'
...
export function Spyglass(props: any) {
  return (
    <svg viewBox='0 0 24 24' {...props}>
      <path
        fill='currentColor'
